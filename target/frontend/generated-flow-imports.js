...
import $css_0 from 'Frontend/styles/views/creditcard/credit-card-view.css';
...
import $css_2 from 'Frontend/styles/views/helloworld/hello-world-view.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/cardlist/card-list-view.css';
