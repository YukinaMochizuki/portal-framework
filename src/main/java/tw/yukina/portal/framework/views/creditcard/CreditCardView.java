package tw.yukina.portal.framework.views.creditcard;
...
@Route(value = "creditcard", layout = MainView.class)
@PageTitle("Credit Card")
@CssImport("styles/views/creditcard/credit-card-view.css")
public class CreditCardView extends Div {
